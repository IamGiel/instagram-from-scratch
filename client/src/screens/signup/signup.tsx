        ...
        <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
          <div className="relative sm:mx-auto sm:w-full sm:max-w-md">
            <img
              ...
              alt="Your Company"
            />
            <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Sign up now to get started</h2>
            <p className="mt-2 text-center text-sm text-gray-600">
            <div className="start-your-trial flex items-center justify-center">
              <Tooltip tooltipMsg='Coming soon!'>
                Or&nbsp;
            ...
            <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
              ...
              <div>
                ...
                <div className="flex items-center justify-between">
                  <Tooltip tooltipMsg="Feature coming soon...">
                  ...
                  <Tooltip tooltipMsg="Will be implemented soon!">
                ...
                {/* error message */}
                {resError && <p className="text-sm font-medium text-red-500">{resError}</p>}
