...
export const Create = () => {
  ...
  const assignees = [
    { name: 'private', avatar:faker.image.technics(1234, 2345, true), value:'private' },
    { name: 'public', avatar:faker.image.technics(1234, 2345, true), value:'public' }
    // More items...
  ]
  const labels = [
    ...
    <div className='m-[12px]'>
      ...
      <div className="p-[12px] overflow-hidden rounded-lg border border-gray-300 shadow-sm focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
        ...
        <div className='flex flex-row gap-4'>
          <label htmlFor="title" className='p-[12px] border-solid border-500-sky border-1 pt-2.5 text-lg font-medium text-gray-500'>
            Title:
          </label>
          <input
            type="text"
        ...
        <label htmlFor="description" className='p-[12px] flex w-full border-solid border-300-sky border-1 pt-2.5 text-lg font-medium text-gray-500'>
          Body:
        </label>
        <textarea
          rows={2}
        ...
        <label htmlFor="Image URL" className='p-[12px] flex w-full border-solid border-300-sky border-1 pt-2.5 text-lg font-medium text-gray-500'>
          Image URL:
        </label>
        <input
          type="text"
                      ...
                      {assignees.map((assignee,idx) => (
                        ...
                        >
                          <div className="flex items-center">
                            {assignee.avatar ? (
                              <img src={assignee.avatar} alt="avatar" className="h-5 w-5 flex-shrink-0 rounded-full" />
                            ) : (
